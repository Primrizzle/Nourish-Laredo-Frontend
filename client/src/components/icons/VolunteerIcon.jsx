export default function VolunteerIcon({ className = "" }) {
  return (
    <svg
    ...
    >
      ...
      <path
        d="M21.3333 4.17065C22.477 4.46715 23.4898 5.13501 24.2129 6.0694C24.9359 7.0038 25.3282 8.15184 25.3282 9.33332C25.3282 10.5148 24.9359 11.6628 24.2129 12.5972C23.4898 13.5316 22.477 14.1995 21.3333 14.496"
        stroke="currentColor"
        strokeWidth={2.66667}
        strokeLinecap="round"
        strokeLinejoin="round"
